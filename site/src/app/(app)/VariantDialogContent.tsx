...
export default function VariantDialogContent(props: {
  ...
  return (
    <DialogContent className="z-[30] top-1/2 left-1/2 fixed -translate-x-1/2 -translate-y-1/2 
          bg-theme-card w-full max-w-screen-lg p-8 
          h-full lg:h-auto
          lg:rounded-2xl
    ...
    >
      ...
      <div className="flex flex-row gap-8 w-full">
        <div className="flex flex-col flex-1 gap-2">
          ...
          >
            <div className="absolute top-2 left-4 z-10">Preview:</div>
            <div className="absolute top-2 right-2 h-10 z-10 flex">
              <ThemeDropdown />
            </div>
          ...
          <div className="flex gap-2">
            ...
            >
              <IcRoundDownload
                className="text-2xl group-hover:text-theme-strong" />
              Download
            </button>
            <button
              className={button('group flex-1 bg-theme-cardHover hover:bg-theme-bg')}
            ...
            >
              <IcRoundFileCopy className="text-2xl group-hover:text-theme-strong" />
              Copy
            </button>
          </div>
        </div>
